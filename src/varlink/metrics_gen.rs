//! Generated code for Varlink interface `io.systemd.Metrics`.
//!
...
impl ListOutput {
    ...
    /// Returns the string value or "unknown" if not present
    pub fn value_as_string(&self) -> &str {
        self.value.as_string("unknown")
    }

    /// Returns the int value as u64 or 0 if not present
...
mod tests {
    ...
    fn test_value_as_string_without_value() {
        ...
        assert_eq!(output.value_as_string(), "unknown");
    }
